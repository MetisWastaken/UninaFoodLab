...
//costruttore default (inizializza a 0)
    public Report() {
        this(
            0,
            0,
    ...
    public Report(int numero_corsi_totali, int numero_sessioni_online, int numero_sessioni_pratiche,
            Map<Sessione, Integer> numero_ricette_per_sessione) {
    ...
    public Map<Sessione, Integer> getNumeroRicettePerSessione() {
        return new HashMap<>(numero_ricette_per_sessione);
    }
}
